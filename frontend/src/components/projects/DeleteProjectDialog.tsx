...
export function DeleteProjectDialog({ project, deleting, onCancel, onConfirm }: DeleteProjectDialogProps) {
  if (!project) {
    return null;
  }
    ...
    <div className="fixed inset-0 z-30 flex items-center justify-center bg-slate-900/40 p-4">
      <div className="w-full max-w-md rounded-xl bg-white p-5 shadow-xl">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Esta acción eliminará <strong>{project.projectName}</strong> y sus datos relacionados.
        </p>
